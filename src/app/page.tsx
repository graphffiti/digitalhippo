...
const perks = [
  ...
  },
  {
    name: "For the planet",
    icon: Leaf,
    description: "We've pledge 1% of the sales to the planet. "
  },
]
  ...
  return (
    ...
    <MaxWidthWrapper>
      <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">Welcome to DigitalHippo. Every asset on our platform is verified by our team to ensure highest quality standards.</p>
          ...
          {perks.map(
            (perk) => (
              <div key={perk.name} className="text-center md:flex md:items-start md:text-left lg:block lg:text-center">
                <div className="justify-center flex md:flex-shrink-0">
